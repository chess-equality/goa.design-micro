...
//
// calcsvc HTTP server encoders and decoders
//
// Command:
...
// EncodeAddResponse returns an encoder for responses returned by the calcsvc
// add endpoint.
...
// DecodeAddRequest returns a decoder for requests sent to the calcsvc add
// endpoint.
