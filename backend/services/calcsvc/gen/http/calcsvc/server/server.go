...
// New instantiates HTTP handlers for all the calcsvc service endpoints.
func New(
	e *calcsvc.Endpoints,
	mux goahttp.Muxer,
...
func (s *Server) Service() string { return "calcsvc" }
